...
public class WebViewFlutterPlugin implements FlutterPlugin, ActivityAware {
  ...
  public void onAttachedToActivity(@NonNull ActivityPluginBinding binding) {
    fileChooser = new FileChooser(binding.getActivity());
    binding.addActivityResultListener(new PluginRegistry.ActivityResultListener() {
      @Override
      public boolean onActivityResult(int requestCode, int resultCode, Intent data) {
        if (fileChooser != null && fileChooser.resultHandler != null) {
          return fileChooser.resultHandler.handleResult(requestCode,resultCode,data);
        }
        return false;
      }
    });
